...
int main() {
    ...
    RungeKutta2(X, C_1_default, C_2_default, alph, h);
...
/*
    ...
    // cout << setprecision(20) << M_PI << "pa pam" << endl;;
    // cout << "out" << endl;
}
...
void RungeKutta2(vector<MyVector> &X, double C1, double C2, double alph, vector<double> &H) {
    ...
    do {
        ...
        do {
            ...
            half = countStep(h/2., buf, alph);
            half = countStep(h/2., half, alph);
            ...
            // out << "h: " << h << " " << E.x[0] << " "<< E.x[1] << " "<< E.x[2] << " "<< E.x[3] << " pos " << pos << endl;
            out << "h: " << h << " pos: " << pos <<  " " << full.x[1] << " " << full.x[3] << endl;
